...
def hrmatching(hr_xcord,hr_ycord):
    ...
    classifval = convert_coord_sys(hr_xcord, 50, -100, 7, 0)
    # print(classifval)
    if classifval >= 6:
    ...
    snap_hr_xcord = convert_coord_sys(classifval, 7,0,50, -100)
...
print(hrmatching(-90,40)) #low temp, high luminosity should match a white dwarf with low radius white color

#print(hrmatching(40,-90)) #high temp, low luminosity should match a  red giant/super giant with big radius orange/red color
